$(document).ready(function() {
  ...
  $("#research-caption").hover(function() {
    $("#research-caption").css("background", "white");
    $("#research-words").css("color", "#5B6982");
  }, function() {
    $("#research-caption").css("background", "none");
    $("#research-words").css("color", "white");
  });

  $("#cs234-caption").hover(function() {
    $("#cs234-caption").css("background", "white");
    $("#cs234-words").css("color", "#5B6982");
  }, function() {
    $("#cs234-caption").css("background", "none");
    $("#cs234-words").css("color", "white");
  });
